...
response = sfn_client.start_execution(
    ...
    input=json.dumps({
        ...
        'ACTION':'deploy', # deploy / inference
        ...
        'GROUND_TRUTH_DIR':'s3://omm-test-bucket/abalone-ground-truth',
        'BATCH_INPUT_DIR':'s3://omm-test-bucket/abalone-batch-input',
