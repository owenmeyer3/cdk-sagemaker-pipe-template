...
class DataQualityBaseliningTask(ECSFargate):
    def __init__(
        self,
        scope, 
        construct_id, 
...
class ModelQualityBaseliningTask(ECSFargate):
    def __init__(
        self,
        scope, 
        construct_id, 
...
class ModelBiasBaseliningTask(ECSFargate):
    def __init__(
        self,
        scope, 
        construct_id, 
...
class ModelExplainabilityBaseliningTask(ECSFargate):
    def __init__(
        self,
        scope, 
        construct_id, 
